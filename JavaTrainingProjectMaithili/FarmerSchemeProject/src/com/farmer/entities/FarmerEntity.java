...
public class FarmerEntity {
	...
	public FarmerEntity(String farmerName, String phoneNumber, String email,String area, String city, String state, String pinCode,
			 String accountNumber, String ifscCode, String aadharCard,
			String panCard, String password) {
		super();
